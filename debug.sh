...
qemu-system-x86_64 -s -S -m 4096m -hda build/disk.img &
...
gdb -ix "gdb_init_test.txt" -ex "target remote localhost:1234" -ex "br *0x8521" -ex "br *0x00" -ex "br *0x172f" -ex "br *0xFF000000" -ex "watch *0x00" -ex "watch *0x01" -ex "watch *0x02" -ex "watch *0x1c2000" -ex "watch *0x1c0cd5" -ex "c"
