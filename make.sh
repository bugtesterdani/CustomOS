...
# gdb -ix "gdb_init_test.txt" -ex "target remote localhost:1234" -ex "br *0x8400" -ex "c"
gdb -ix "gdb_init_real_mode.txt" -ex "target remote localhost:1234" -ex "br *0x8400" -ex "c"
